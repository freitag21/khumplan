  ...
  return legalDoc({
    ...
    sections: [
      ...
      { h: 'การเป็นสมาชิกทีม (Team) และการออกจากทีม', body: [
        `เมื่อ ${BRAND_TH} เปิดฟีเจอร์สำหรับทีม/เอเจนซี หัวหน้าทีมที่ซื้อแพ็กเกจ Team จะเห็นได้เฉพาะ "ข้อมูลสรุปและกิจกรรม" ของสมาชิกในทีม (เช่น จำนวนเคส ความเคลื่อนไหวล่าสุด ยอดรวม) เท่านั้น — หัวหน้าทีม ไม่มีสิทธิ์เข้าถึงชื่อ ข้อมูล หรือผลวิเคราะห์ของลูกค้ารายบุคคลของสมาชิก`,
        'สมุดลูกค้า ผลวิเคราะห์ กรมธรรม์ และบันทึกการติดต่อ ยังคงเป็นข้อมูลที่สมาชิก (ตัวแทน) เป็นผู้ควบคุมข้อมูลส่วนบุคคล ไม่ใช่ของหัวหน้าทีมหรือของทีม',
        [
          'เมื่อสมาชิกออกจากทีมหรือทีมยุติแพ็กเกจ: สมาชิกยังเข้าถึงข้อมูลลูกค้าของตนได้ครบถ้วน (ปรับลดสิทธิ์เป็นระดับฟรี/Pro) และส่งออกข้อมูลของตนได้ตลอดเวลา',
          'การตั้งค่าเฉพาะทีม (เช่น สมมติฐานมาตรฐานทีม โลโก้ทีมบนรายงาน) จะถูกยกเลิกจากบัญชีของสมาชิกที่ออกจากทีม',
          'ข้อมูลสรุป/กิจกรรมในอดีตที่หัวหน้าทีมเคยเห็น จะยังคงอยู่ในแดชบอร์ดของหัวหน้าทีมในรูปแบบข้อมูลรวมที่ไม่ระบุตัวลูกค้า',
        ],
        'การเชิญสมาชิกเข้าทีมต้องได้รับความยินยอมจากสมาชิกก่อนเสมอ',
      ] },
