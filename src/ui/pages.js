  ...
  return legalDoc({
    ...
    sections: [
      ...
      { h: 'การเก็บรักษาและการลบ', body: [
        ...
        'ตัวแทนปิดบัญชีได้เองจากแดชบอร์ด (เมนูโปรไฟล์ตัวแทน → ปิดบัญชีและลบข้อมูลทั้งหมด) — เมื่อปิดบัญชี ระบบจะลบบัญชีและผลวิเคราะห์ลูกค้าทั้งหมดทันที และลิงก์แชร์ทุกลิงก์จะหยุดทำงาน',
      ] },
