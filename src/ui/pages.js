...
export function renderSupport({ onBack } = {}) {
  ...
  return h('div', { class: 'support-page' },
    h('div', { class: 'support-hero' },
      ...
      h('p', {}, `${BRAND === 'KhumPlan' ? 'คุ้มแพลน' : BRAND} ทำโดยตัวแทนคนเดียว — เครื่องมือวิเคราะห์หลักฟรีตลอดไป · แพ็กเกจ Pro และ Team แบบเสียค่าบริการกำลังพัฒนา`),
...
const GUIDE_STEPS = [
  ...
  ['บันทึกเข้าสมุดลูกค้า (ต้องเข้าสู่ระบบ)',
    'สมัครด้วยอีเมลและรหัสผ่าน ก่อนบันทึกต้องยืนยันความยินยอมจากลูกค้า และหากจะเก็บข้อมูลสุขภาพต้องติ๊กช่องความยินยอมโดยชัดแจ้งแยกต่างหาก (PDPA ม.26) — คุณเป็นผู้ควบคุมข้อมูล หมายความว่าหน้าที่ตามกฎหมายในการขอความยินยอมและตอบคำขอใช้สิทธิของลูกค้าเป็นของคุณ ไม่ใช่ของคุ้มแพลน · ระบบไม่แชร์ข้อมูลลูกค้าให้ตัวแทนคนอื่น'],
  ...
  return legalDoc({
    ...
    sections: [
      ...
      { h: 'ผู้มีสิทธิใช้งาน', body: [
        'ผู้ใช้ต้องเป็นตัวแทนหรือนายหน้าประกันชีวิตที่มีใบอนุญาตจากนายทะเบียนและใบอนุญาตยังมีผลใช้ได้',
        'ผู้ที่อยู่ระหว่างการอบรมหรือรอผลสอบเพื่อขอรับใบอนุญาต ใช้งานได้เฉพาะเพื่อการฝึกหัดกับข้อมูลสมมติเท่านั้น ห้ามใช้กับลูกค้าหรือผู้มุ่งหวังจริงจนกว่าจะได้รับใบอนุญาต',
      ...
      { h: 'สิ่งที่ห้ามทำ', body: [[
        ...
        'พยายามเจาะระบบ ดึงข้อมูลจำนวนมากโดยอัตโนมัติ หรือรบกวนการทำงานของระบบ',
        `ทำวิศวกรรมย้อนกลับ คัดลอกโครงสร้างการคำนวณ หรือใช้ซอฟต์แวร์ การออกแบบ และวิธีการนำเสนอของ ${BRAND_TH} เพื่อพัฒนาบริการที่มีลักษณะเดียวกัน`,
      ]] },
      { h: 'แหล่งรายได้ของเรา', body: [
        `${BRAND_TH} มีรายได้จากค่าบริการซอฟต์แวร์ที่ผู้ใช้ชำระเท่านั้น เราไม่รับค่าตอบแทน ค่าแนะนำ หรือส่วนแบ่งใด ๆ จากบริษัทประกันภัย ไม่จำหน่ายรายชื่อผู้มุ่งหวัง และไม่รับค่าตอบแทนจากการที่ผู้ใช้เลือกผลิตภัณฑ์ของบริษัทใด`,
      ] },
      { h: 'การประมวลผลข้อมูลส่วนบุคคลของลูกค้า (ผู้ควบคุม–ผู้ประมวลผล)', body: [
        ...
        [
          ...
          'ไม่ใช้ข้อมูลลูกค้าเพื่อวัตถุประสงค์ของตนเอง ไม่นำไปวิเคราะห์รวมเชิงพาณิชย์ ฝึกสอนแบบจำลอง หรือเปิดเผยต่อบุคคลที่สาม เว้นแต่ได้รับคำสั่งจากผู้ควบคุมข้อมูล',
          'เปิดให้ส่งออกข้อมูลได้ 30 วัน และลบข้อมูลทั้งหมดรวมถึงสำเนาสำรองภายใน 90 วันเมื่อตัวแทนสั่งลบ ปิดบัญชี หรือยุติการใช้บริการ เว้นแต่ต้องเก็บตามกฎหมาย',
          'แจ้งตัวแทนภายใน 24 ชั่วโมงนับแต่ทราบเหตุละเมิดข้อมูลส่วนบุคคล เพื่อให้ตัวแทนแจ้งสำนักงานคณะกรรมการคุ้มครองข้อมูลส่วนบุคคลได้ภายใน 72 ชั่วโมงตามมาตรา 37(4)',
        ],
        h('p', { class: 'legal-p' }, 'รายละเอียดครบถ้วนอยู่ใน ',
          h('a', { href: '?view=dpa' }, 'ภาคผนวก ก. ข้อตกลงการประมวลผลข้อมูลส่วนบุคคล'),
          ' ซึ่งถือเป็นส่วนหนึ่งของข้อกำหนดนี้'),
        'ตัวแทนต้องขอความยินยอมจากลูกค้าและใช้สิทธิของเจ้าของข้อมูลในฐานะผู้ควบคุมข้อมูล',
      ] },
      { h: 'การเป็นสมาชิกทีม (Team) และการออกจากทีม', body: [
        `เมื่อ ${BRAND_TH} เปิดฟีเจอร์สำหรับทีม/เอเจนซี หัวหน้าทีมหรือเอเจนซีที่ชำระค่าบริการ ("ผู้ซื้อแพ็กเกจ") เป็นคู่สัญญากับ ${BRAND_TH} ในส่วนของค่าบริการเท่านั้น สมาชิกแต่ละคนเป็นคู่สัญญาแยกต่างหากในส่วนการใช้งาน และเป็นผู้ควบคุมข้อมูลส่วนบุคคลของลูกค้าตนเอง`,
        'การชำระค่าบริการไม่ทำให้ผู้ซื้อแพ็กเกจมีสิทธิใด ๆ ในข้อมูลลูกค้าของสมาชิก และไม่ทำให้ผู้ซื้อแพ็กเกจเป็นผู้ควบคุมข้อมูลนั้น',
        'หัวหน้าทีมเห็นได้เฉพาะข้อมูลสรุปรวมของทีม (จำนวนเคส ความเคลื่อนไหวล่าสุด ยอดรวมช่องว่างความคุ้มครองของทีม) ไม่เห็นชื่อ ข้อมูล หรือผลวิเคราะห์ของลูกค้ารายบุคคลของสมาชิก',
        'เมื่อสมาชิกเข้าร่วมทีม สมาชิกยินยอมให้เปิดเผยข้อมูลกิจกรรมการใช้งานของตน (วันที่ใช้งานล่าสุด จำนวนผลวิเคราะห์ จำนวนลูกค้าในสมุด) ต่อหัวหน้าทีมเพื่อการบริหารทีม โดยเพิกถอนความยินยอมได้ด้วยการออกจากทีม การเชิญสมาชิกเข้าทีมต้องได้รับความยินยอมจากสมาชิกก่อนเสมอ',
        'เมื่อสมาชิกออกจากทีม ไม่ว่าด้วยเหตุใด:',
        [
          'สมาชิกยังเข้าถึงลูกค้า ผลวิเคราะห์ กรมธรรม์ และบันทึกการติดต่อของตนได้ครบถ้วนทันทีในระดับบัญชีฟรี และส่งออกเป็นไฟล์ได้ตลอดเวลา',
          `${BRAND_TH} จะคงสิทธิ์ระดับแพ็กเกจเดิมให้สมาชิกต่ออีก 30 วัน เพื่อจัดการงานที่ค้างและส่งออกข้อมูล`,
          `${BRAND_TH} จะไม่โอน ไม่คัดลอก และไม่มอบข้อมูลลูกค้าของสมาชิกให้แก่หัวหน้าทีม เอเจนซี หรือสมาชิกรายอื่น ไม่ว่าในกรณีใด แม้ได้รับการร้องขอเป็นหนังสือจากผู้ซื้อแพ็กเกจ เนื่องจากสมาชิกเป็นผู้ควบคุมข้อมูลนั้น`,
          `หากมีข้อพิพาทระหว่างสมาชิกกับหัวหน้าทีมหรือต้นสังกัดเกี่ยวกับสิทธิในข้อมูลลูกค้า ${BRAND_TH} จะคงสถานะข้อมูลไว้ตามที่เป็นอยู่และไม่เป็นผู้ชี้ขาด`,
          'การตั้งค่าเฉพาะทีม (สมมติฐานมาตรฐานทีม โลโก้ทีมบนรายงาน) จะถูกยกเลิกจากบัญชีของสมาชิก',
          'แดชบอร์ดของหัวหน้าทีมจะแสดงเฉพาะตัวเลขสรุปรวมของทีมในอดีต โดยไม่แสดงชื่อ ตัวตน หรือกิจกรรมรายบุคคลของสมาชิกที่ออกไป และไม่แสดงข้อมูลลูกค้าใด ๆ',
        ],
        `หากผู้ซื้อแพ็กเกจไม่ต่ออายุหรือค้างชำระ ${BRAND_TH} จะแจ้งสมาชิกทุกคนโดยตรงล่วงหน้าไม่น้อยกว่า 15 วันก่อนปรับลดสิทธิ์ และสมาชิกมีสิทธิซื้อแพ็กเกจรายบุคคลต่อเนื่องเองได้`,
      ] },
      { h: 'ค่าบริการและการชำระเงิน', body: [
        `${BRAND_TH} มีทั้งบริการฟรีและแพ็กเกจแบบเสียค่าบริการ (Pro / Team) ซึ่งอยู่ระหว่างการพัฒนา — เมื่อเปิดให้บริการ เงื่อนไขในหัวข้อนี้จะมีผลกับผู้ซื้อแพ็กเกจ`,
        [
          'แพ็กเกจแบบเสียค่าบริการชำระล่วงหน้าเป็นรายปีตามอัตราที่ตกลงในใบแจ้งหนี้ ราคายังไม่รวมภาษีมูลค่าเพิ่ม (หากมี) และไม่รวมภาษีหัก ณ ที่จ่ายซึ่งเป็นหน้าที่ของผู้ชำระเงิน',
          'แพ็กเกจไม่ต่ออายุอัตโนมัติ เราจะแจ้งเตือนก่อนหมดอายุไม่น้อยกว่า 30 วัน',
          'ผู้ใช้ขอคืนค่าบริการเต็มจำนวนได้ภายใน 14 วันนับแต่วันเริ่มแพ็กเกจ หลังจากนั้นไม่มีการคืนเงิน เว้นแต่กรณีที่เราหยุดให้บริการถาวร ซึ่งจะคืนตามสัดส่วนระยะเวลาที่เหลือ',
          'เมื่อแพ็กเกจสิ้นสุดโดยไม่ต่ออายุ บัญชีจะปรับลดเป็นระดับฟรี โดยข้อมูลของผู้ใช้ยังคงอยู่และส่งออกได้เป็นเวลาไม่น้อยกว่า 90 วัน — เราจะไม่ลบข้อมูลลูกค้าของท่านเพียงเพราะไม่ต่ออายุ',
        ],
      ] },
      { h: 'บริการให้ "ตามสภาพ" และการหยุดให้บริการ', body: [
        `บริการฟรีของ ${BRAND_TH} ให้บริการ "ตามสภาพที่เป็นอยู่" (as-is) โดยไม่รับประกันความพร้อมใช้งานต่อเนื่อง`,
        'สำหรับบริการที่มีค่าบริการ ผู้ให้บริการจะใช้ความพยายามตามสมควรในการให้บริการอย่างต่อเนื่อง หากบริการหยุดชะงักเกิน 72 ชั่วโมงติดต่อกันโดยมิใช่เหตุสุดวิสัย ผู้ใช้มีสิทธิขอขยายอายุแพ็กเกจตามระยะเวลาที่ขาดหาย',
        'เราอาจปรับปรุง เปลี่ยนแปลง ระงับ หรือยุติบริการ (ทั้งหมดหรือบางส่วน) โดยจะแจ้งล่วงหน้าตามสมควรหากเป็นการยุติถาวร เพื่อให้ตัวแทนส่งออกข้อมูลของตน',
        'ตัวแทนปิดบัญชีและลบข้อมูลผลวิเคราะห์ทั้งหมดของตนได้เองจากแดชบอร์ด (เมนูโปรไฟล์ตัวแทน)',
      ] },
      { h: 'ข้อจำกัดความรับผิด', body: [
        `เท่าที่กฎหมายอนุญาต ${BRAND_TH} และผู้พัฒนาไม่รับผิดต่อความเสียหายทางอ้อม ความเสียหายสืบเนื่อง หรือการสูญเสียโอกาสทางธุรกิจ ที่เกิดจากการใช้หรือไม่สามารถใช้บริการได้`,
        `ความรับผิดรวมของ ${BRAND_TH} ในทุกกรณีไม่เกินค่าบริการที่ผู้ใช้ชำระจริงใน 12 เดือนก่อนเกิดเหตุ (สำหรับผู้ใช้บริการฟรี ไม่เกิน 5,000 บาท)`,
        'ข้อจำกัดข้างต้นไม่ใช้กับความรับผิดที่เกิดจากการจงใจหรือประมาทเลินเล่ออย่างร้ายแรง',
      ...
      { h: 'ทรัพย์สินทางปัญญาและข้อมูล', body: [
        `ซอฟต์แวร์ การออกแบบ ข้อความ และเครื่องหมาย ${BRAND_TH} เป็นของผู้พัฒนา`,
        'สำหรับข้อมูลส่วนบุคคลที่ตัวแทนกรอกและบันทึก ตัวแทนเป็นผู้ควบคุมข้อมูลส่วนบุคคลนั้น และลูกค้าเป็นเจ้าของข้อมูลส่วนบุคคลผู้ทรงสิทธิตามกฎหมาย เราใช้ข้อมูลเพื่อให้บริการตามที่ระบุในนโยบายความเป็นส่วนตัวเท่านั้น',
      ] },
      { h: 'การเปลี่ยนแปลงข้อกำหนดและกฎหมายที่ใช้บังคับ', body: [
        'เราอาจปรับปรุงข้อกำหนดนี้เป็นครั้งคราว การเปลี่ยนแปลงที่กระทบสิทธิของผู้ใช้อย่างมีนัยสำคัญ เราจะแจ้งล่วงหน้าไม่น้อยกว่า 30 วันทางอีเมลและในแอป',
        'หากผู้ใช้ไม่ประสงค์จะยอมรับการเปลี่ยนแปลง ผู้ใช้มีสิทธิบอกเลิกและขอคืนค่าบริการตามสัดส่วนของระยะเวลาที่เหลือ โดยแจ้งภายใน 30 วันนับแต่วันที่การเปลี่ยนแปลงมีผล',
        'ข้อกำหนดนี้อยู่ภายใต้กฎหมายไทย ข้อพิพาทให้เสนอต่อศาลที่มีเขตอำนาจในประเทศไทย',
      ] },
      { h: 'ติดต่อ', body: [
  ...
  return legalDoc({
    ...
    sections: [
      ...
      { h: 'ข้อมูลที่เก็บ', body: [[
        ...
        'ข้อมูลของบุคคลที่สามที่ตัวแทนกรอก: ชื่อและความสัมพันธ์ของผู้รับประโยชน์ และข้อมูลบุตร/ผู้อยู่ในอุปการะ (อายุ) — ตัวแทนต้องแจ้งและได้รับความยินยอมจากบุคคลเหล่านั้น หรือจากผู้ใช้อำนาจปกครองกรณีผู้เยาว์',
        'ข้อมูลอ่อนไหว (PDPA มาตรา 26 — ต้องได้รับความยินยอมโดยชัดแจ้งแยกต่างหากจากลูกค้าก่อนบันทึก): สถานะการสูบบุหรี่ · สิทธิการรักษาพยาบาล · ข้อยกเว้น เบี้ยเพิ่ม หรือเงื่อนไขจากการพิจารณารับประกันที่ตัวแทนบันทึกไว้ในกรมธรรม์ · สถานะสุขภาพที่ระบุในการคัดกรอง MANHA',
        'ข้อมูลการใช้งานทางเทคนิคเท่าที่จำเป็น เช่น เวลาที่สร้าง/แก้ไขข้อมูล และเวอร์ชันของเอกสารที่ยอมรับ (ระบบไม่ติดตั้งเครื่องมือวิเคราะห์พฤติกรรมของบุคคลที่สาม)',
      ]] },
      { h: 'ฐานการประมวลผลและวัตถุประสงค์', body: [
        'ข้อมูลลูกค้าทั่วไป: ประมวลผลบนฐาน "ความยินยอม" ตามมาตรา 19 ที่ตัวแทนขอจากลูกค้า เพื่อจัดทำผลวิเคราะห์ความต้องการความคุ้มครอง จัดทำเอกสาร PDF และลิงก์สรุป จัดเก็บกรมธรรม์ที่ลูกค้าถืออยู่ และช่วยตัวแทนวางแผนการติดต่อและบริการหลังการขาย',
        'ข้อมูลอ่อนไหว (สุขภาพ): ประมวลผลบนฐาน "ความยินยอมโดยชัดแจ้ง" ตามมาตรา 26 วรรคหนึ่ง ซึ่งตัวแทนต้องขอแยกต่างหากจากความยินยอมทั่วไป — ระบบมีช่องยืนยันความยินยอมนี้แยกต่างหาก และหากไม่ได้รับ ตัวแทนควรเว้นช่องข้อมูลสุขภาพไว้',
        ...
        'หลักฐานการยอมรับข้อกำหนด/นโยบาย: เก็บบนฐานประโยชน์โดยชอบด้วยกฎหมายในการก่อตั้งสิทธิเรียกร้องตามกฎหมาย (มาตรา 24(4)) โดยเก็บเป็นบันทึกที่แก้ไขไม่ได้',
        'หากไม่บันทึก ระบบจะคำนวณในเครื่องของผู้ใช้และไม่ส่งข้อมูลลูกค้าไปเก็บที่เซิร์ฟเวอร์',
      ] },
      { h: 'การเก็บรักษาและการลบ', body: [
        'ตัวแทน (ผู้ควบคุมข้อมูล) เป็นผู้กำหนดระยะเวลาเก็บข้อมูลลูกค้าตามความจำเป็นและตามความยินยอมที่ได้รับ และลบแต่ละรายการได้ตลอดเวลาโดยมีผลถาวร',
        `${BRAND_TH} ช่วยตัวแทนลดการเก็บข้อมูลเกินจำเป็นด้วยแนวทางต่อไปนี้:`,
        [
          'ลิงก์สรุปสำหรับลูกค้า (แชร์) — เปิดดูได้จนกว่าจะครบ 90 วันหรือตัวแทนปิดลิงก์ · ตัวแทนปิด/เปิดลิงก์ได้เองจากแดชบอร์ด',
          'ผู้มุ่งหวังที่ไม่มีการติดต่อเกิน 24 เดือน — ระบบแจ้งเตือนตัวแทนให้ขอความยินยอมใหม่หรือลบ',
          'เมื่อตัวแทนลบลูกค้าออกจากสมุด ระบบจะลบกรมธรรม์ รายการติดตาม และบันทึกการติดต่อของลูกค้าคนนั้นด้วย และตัวแทนเลือกให้ลบผลวิเคราะห์ที่ผูกไว้พร้อมกันได้ (เป็นค่าเริ่มต้น)',
          'หลักฐานการยอมรับข้อกำหนด/นโยบายของตัวแทน เก็บเป็นบันทึกที่แก้ไข/ลบไม่ได้ ในรูปแบบที่ไม่ระบุอีเมลหรือชื่อ เพื่อใช้ก่อตั้งสิทธิเรียกร้องตามกฎหมาย',
        ],
        'ตัวแทนปิดบัญชีได้เองจากแดชบอร์ด — เมื่อปิดบัญชี ระบบจะลบบัญชี ผลวิเคราะห์ สมุดลูกค้า กรมธรรม์ และรายการติดตามทั้งหมดทันที และลิงก์แชร์ทุกลิงก์จะหยุดทำงาน',
      ] },
      { h: 'การเปิดเผยและผู้ให้บริการภายนอก', body: [
        ...
        'กรณีตัวแทนเข้าร่วมทีม/เอเจนซีผ่านฟีเจอร์ Team: หัวหน้าทีมเห็นได้เฉพาะข้อมูลสรุปและกิจกรรมแบบรวม (ไม่ระบุตัวลูกค้า) — ไม่เห็นชื่อหรือข้อมูลลูกค้ารายบุคคลของสมาชิก (ดูข้อกำหนดการใช้งาน หัวข้อการเป็นสมาชิกทีม)',
        `${BRAND_TH} ไม่ขายหรือให้เช่าข้อมูลส่วนบุคคล`,
        'ผู้ประมวลผลช่วง (sub-processor) ที่ประมวลผลข้อมูลแทนเรา: Supabase (ฐานข้อมูลและระบบยืนยันตัวตน จัดเก็บในเขตประเทศสิงคโปร์) · Vercel (โฮสต์เว็บแอป) · Resend (ส่งอีเมลระบบ เช่น ยืนยันอีเมลและรีเซ็ตรหัสผ่าน) — ทั้งหมดอยู่ภายใต้ข้อตกลงการประมวลผลข้อมูลและข้อสัญญามาตรฐานของผู้ให้บริการแต่ละราย',
        'อาจเปิดเผยเมื่อมีคำสั่งโดยชอบด้วยกฎหมายจากหน่วยงานที่มีอำนาจ',
      ] },
      { h: 'การส่งหรือโอนข้อมูลไปต่างประเทศ', body: [
        'ข้อมูลถูกจัดเก็บบนเซิร์ฟเวอร์ในประเทศสิงคโปร์ และผู้ให้บริการโครงสร้างพื้นฐานอาจประมวลผลข้อมูลในประเทศอื่น',
        'การส่งหรือโอนข้อมูลดังกล่าวอาศัยฐานความจำเป็นเพื่อปฏิบัติตามสัญญาการใช้บริการ และในกรณีข้อมูลของลูกค้า อาศัยความยินยอมของเจ้าของข้อมูลซึ่งได้รับแจ้งแล้วว่าประเทศปลายทางอาจมีมาตรฐานการคุ้มครองข้อมูลส่วนบุคคลไม่เพียงพอตามมาตรฐานของประเทศไทย (มาตรา 28) เราจัดให้มีข้อตกลงการประมวลผลข้อมูลและข้อสัญญามาตรฐานกับผู้ให้บริการทุกราย',
      ] },
      { h: 'มาตรการความปลอดภัยและการแจ้งเหตุละเมิด', body: [[
        ...
        'หลักฐานความยินยอมของลูกค้าและการยอมรับนโยบายของตัวแทน ถูกล็อกไม่ให้แก้ไขย้อนหลังในระดับฐานข้อมูล',
        ...
        'หากเกิดเหตุละเมิดข้อมูลส่วนบุคคล เราจะแจ้งตัวแทน (ในฐานะผู้ควบคุมข้อมูล) ภายใน 24 ชั่วโมงนับแต่ทราบเหตุ เพื่อให้ตัวแทนแจ้งสำนักงานคณะกรรมการคุ้มครองข้อมูลส่วนบุคคลได้ภายใน 72 ชั่วโมงตามมาตรา 37(4)',
      ]] },
      ...
      { h: 'ติดต่อเรื่องข้อมูลส่วนบุคคล', body: [
        `ผู้ควบคุมข้อมูล / ผู้ประมวลผล: ${OWNER_LABEL}`,
        `ผู้ประสานงานด้านการคุ้มครองข้อมูลส่วนบุคคล — อีเมล ${CONTACT.email || '(ระบุในหน้าติดต่อเรา)'}`,
...
export function renderDpa({ onBack } = {}) {
  return legalDoc({
    title: 'ภาคผนวก ก. ข้อตกลงการประมวลผลข้อมูลส่วนบุคคล (DPA)',
    onBack,
    intro: `ข้อตกลงนี้เป็นส่วนหนึ่งของข้อกำหนดการใช้งาน ${BRAND_TH} และมีผลบังคับระหว่างตัวแทนผู้ใช้บริการ ("ผู้ควบคุมข้อมูล") กับ ${OWNER_LABEL} ("ผู้ประมวลผลข้อมูล") สำหรับการประมวลผลข้อมูลส่วนบุคคลของลูกค้าและผู้มุ่งหวัง ตามพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 มาตรา 40`,
    sections: [
      { h: 'คำนิยามและบทบาท', body: [
        'ผู้ควบคุมข้อมูล: ตัวแทนที่กรอกและบันทึกข้อมูลของลูกค้า/ผู้มุ่งหวังลงในระบบ เป็นผู้กำหนดวัตถุประสงค์และวิธีการประมวลผล',
        `ผู้ประมวลผลข้อมูล: ${BRAND_TH} ประมวลผลข้อมูลในนามและตามคำสั่งของผู้ควบคุมข้อมูลเท่านั้น`,
      ] },
      { h: 'ขอบเขต ประเภทข้อมูล และเจ้าของข้อมูล', body: [[
        'ประเภทกิจกรรม: การจัดเก็บ คำนวณ แสดงผลวิเคราะห์ จัดทำเอกสารและลิงก์สรุป และช่วยจัดการงานติดตามลูกค้า',
        'ประเภทข้อมูล: ข้อมูลระบุตัวตนและติดต่อ ข้อมูลการเงินและภาระหนี้ ข้อมูลกรมธรรม์ที่ถืออยู่ เป้าหมายทางการเงิน และข้อมูลอ่อนไหวด้านสุขภาพ (ตามที่ผู้ควบคุมข้อมูลบันทึกและได้รับความยินยอมโดยชัดแจ้ง)',
        'เจ้าของข้อมูล: ลูกค้าและผู้มุ่งหวังของตัวแทน รวมถึงบุคคลที่สามที่ตัวแทนระบุ (ผู้รับประโยชน์ บุตร/ผู้อยู่ในอุปการะ)',
        'ระยะเวลา: ตลอดระยะเวลาที่ผู้ควบคุมข้อมูลใช้บริการ',
      ]] },
      { h: 'ขอบเขตของคำสั่ง', body: [
        'ผู้ประมวลผลจะประมวลผลข้อมูลส่วนบุคคลเฉพาะตามคำสั่งของผู้ควบคุมข้อมูลที่ให้ไว้ผ่านการใช้งานระบบและตามที่ระบุในภาคผนวกนี้เท่านั้น',
        'ผู้ประมวลผลจะไม่ใช้ข้อมูลส่วนบุคคลของลูกค้าเพื่อวัตถุประสงค์ของตนเอง ไม่นำไปวิเคราะห์รวม จัดทำสถิติเชิงพาณิชย์ ฝึกสอนแบบจำลอง หรือเปิดเผยต่อบุคคลที่สาม เว้นแต่ได้รับคำสั่งเป็นหนังสือจากผู้ควบคุมข้อมูล หรือเป็นข้อมูลที่ทำให้ไม่สามารถระบุตัวบุคคลได้อย่างถาวรและผู้ควบคุมข้อมูลได้ยินยอมล่วงหน้า',
      ] },
      { h: 'มาตรการรักษาความมั่นคงปลอดภัย', body: [[
        'เชื่อมต่อผ่าน HTTPS ทั้งหมด และควบคุมสิทธิ์การเข้าถึงข้อมูลระดับแถว (Row Level Security)',
        'รหัสผ่านจัดเก็บแบบเข้ารหัสโดยระบบยืนยันตัวตน',
        'หลักฐานความยินยอมและการยอมรับเอกสาร ล็อกไม่ให้แก้ไขย้อนหลังในระดับฐานข้อมูล',
        'จำกัดบุคคลที่เข้าถึงข้อมูลเท่าที่จำเป็นต่อการให้บริการและบำรุงรักษาระบบ',
      ]] },
      { h: 'ผู้ประมวลผลช่วง (sub-processor)', body: [
        'ผู้ประมวลผลใช้ผู้ประมวลผลช่วงต่อไปนี้: Supabase (ฐานข้อมูลและการยืนยันตัวตน · สิงคโปร์) · Vercel (โฮสต์เว็บแอป) · Resend (อีเมลระบบ) โดยแต่ละรายอยู่ภายใต้ข้อตกลงการประมวลผลข้อมูลและข้อสัญญามาตรฐาน',
        'ผู้ประมวลผลจะแจ้งผู้ควบคุมข้อมูลล่วงหน้าตามสมควรก่อนเพิ่มหรือเปลี่ยนผู้ประมวลผลช่วงที่มีนัยสำคัญ และผู้ควบคุมข้อมูลมีสิทธิคัดค้านโดยการยุติการใช้บริการ',
      ] },
      { h: 'การช่วยเหลือเรื่องสิทธิของเจ้าของข้อมูล', body: [
        'เมื่อผู้ควบคุมข้อมูลร้องขอ ผู้ประมวลผลจะจัดหาข้อมูล ส่งออกข้อมูล หรือดำเนินการลบ/แก้ไข/ระงับการใช้ ภายใน 7 วันนับแต่ได้รับคำขอ เพื่อให้ผู้ควบคุมข้อมูลตอบเจ้าของข้อมูลได้ภายใน 30 วันตามมาตรา 30',
        'ผู้ประมวลผลจะช่วยผู้ควบคุมข้อมูลจัดทำบันทึกรายการกิจกรรมการประมวลผลและการประเมินผลกระทบเท่าที่เกี่ยวข้องกับบริการ',
      ] },
      { h: 'เหตุละเมิดข้อมูลส่วนบุคคล', body: [
        'ผู้ประมวลผลจะแจ้งผู้ควบคุมข้อมูลภายใน 24 ชั่วโมงนับแต่ทราบเหตุ พร้อมข้อมูลเท่าที่มีในขณะนั้น เพื่อให้ผู้ควบคุมข้อมูลแจ้งสำนักงานคณะกรรมการคุ้มครองข้อมูลส่วนบุคคลได้ภายใน 72 ชั่วโมงตามมาตรา 37(4)',
      ] },
      { h: 'การส่งหรือโอนข้อมูลไปต่างประเทศ', body: [
        'ข้อมูลจัดเก็บบนเซิร์ฟเวอร์ในประเทศสิงคโปร์ การโอนอาศัยฐานความจำเป็นเพื่อปฏิบัติตามสัญญา และความยินยอมของเจ้าของข้อมูลซึ่งได้รับแจ้งถึงมาตรฐานการคุ้มครองที่ปลายทางแล้ว (มาตรา 28) โดยมีข้อสัญญามาตรฐานกับผู้ให้บริการทุกราย',
      ] },
      { h: 'สิทธิตรวจสอบ', body: [
        'ผู้ควบคุมข้อมูลมีสิทธิขอข้อมูลและเอกสารตามสมควรเพื่อยืนยันการปฏิบัติตามภาคผนวกนี้ ปีละไม่เกินหนึ่งครั้ง เว้นแต่มีเหตุอันควรสงสัยว่ามีการละเมิด',
      ] },
      { h: 'การสิ้นสุด', body: [
        'เมื่อผู้ควบคุมข้อมูลยุติการใช้บริการ ผู้ประมวลผลจะเปิดให้ส่งออกข้อมูลได้เป็นเวลา 30 วัน และลบข้อมูลทั้งหมดรวมถึงสำเนาสำรองภายใน 90 วันนับแต่วันสิ้นสุด เว้นแต่กฎหมายกำหนดให้เก็บ',
      ] },
      { h: 'การยอมรับ', body: [
        'ผู้ใช้บริการฟรีและ Pro ผูกพันตามภาคผนวกนี้โดยการยอมรับข้อกำหนดการใช้งาน สำหรับดีลแพ็กเกจ Team ผู้ประมวลผลจะจัดทำภาคผนวกนี้เป็นเอกสารแยกให้ผู้ซื้อแพ็กเกจลงนาม',
      ] },
    ],
  });
}
...
const SEV_PREVIEW = [
  ...
  ['ทุพพลภาพ / คุ้มครองรายได้', 88, '#e0902a'],
...
export function renderLanding({ onStart, onPreview, onSignup, onLogin } = {}) {
  ...
  const wrap = h('div', { class: 'landing' },
    ...
    section('สิ่งที่ได้', h('div', { class: 'cols-2' },
      feat('M2.5 13.5V9m4 4.5V5.5m4 8V2.5m4 11V7', 'วิเคราะห์ 6 ด้าน', 'ชีวิต/คุ้มครองรายได้ · สุขภาพ · โรคร้ายแรง · ทุพพลภาพ · เกษียณ · ทุนการศึกษาบุตร'),
    ...
    h('div', { class: 'landing-section land-trust' },
      h('h2', {}, 'ออกแบบโดยคำนึงถึงแนวปฏิบัติ คปภ. และ PDPA'),
      h('ul', { class: 'land-trust-list' },
        h('li', {}, 'ไม่ระบุชื่อแบบประกันหรือบริษัทใด — แนะนำเป็นประเภทความคุ้มครองเท่านั้น'),
        h('li', {}, 'ไม่ใช่ตารางผลประโยชน์ ไม่ใช่เอกสารประกอบการเสนอขาย มีข้อความกำกับบนทุกหน้าผล'),
        h('li', {}, 'ตัวแทนเป็นผู้ควบคุมข้อมูล — ข้อมูลลูกค้าของคุณไม่แชร์ให้ตัวแทนคนอื่น'),
        h('li', {}, 'ก่อนบันทึกต้องยืนยันความยินยอมจากลูกค้า และมีช่องยืนยันความยินยอมข้อมูลสุขภาพแยกต่างหาก (PDPA ม.26)'))),
    h('hr', { class: 'hr', style: 'margin:0' }),
...
function faq() {
  const items = [
    ...
    ['ตัวเลขที่ได้เป็นการรับประกันผลประโยชน์หรือไม่', 'ไม่ใช่ ทุกหน้าผลมีข้อความกำกับว่าเป็นการประมาณการเพื่อประกอบการวางแผน ไม่ใช่ตารางผลประโยชน์ของบริษัทประกัน และไม่ใช่คำแนะนำการลงทุน'],
