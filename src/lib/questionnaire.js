...
export const SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'existingTpdSum', label: 'ทุนทุพพลภาพถาวรสิ้นเชิง (TPD) จ่ายเป็นก้อน', type: 'money' },
      { key: 'disabilityBenefitMonthly', label: 'ชดเชยรายได้กรณีทุพพลภาพ ต่อเดือน (ถ้ามี)', type: 'money' },
      { key: 'hasWaiverOfPremium', label: 'มีสัญญายกเว้นการชำระเบี้ย (WP) กรณีทุพพลภาพ', type: 'checkbox' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'groupTpdSum', label: 'ประกันกลุ่ม: ทุนทุพพลภาพถาวรสิ้นเชิง (จ่ายก้อน)', type: 'money' },
...
export function toNeedsInput(raw) {
  ...
  return {
    ...
    existingTpdSum: numOr(r.existingTpdSum),
    disabilityBenefitMonthly: numOr(r.disabilityBenefitMonthly),
    hasWaiverOfPremium: !!r.hasWaiverOfPremium,
    ...
    groupTpdSum: numOr(r.groupTpdSum),
